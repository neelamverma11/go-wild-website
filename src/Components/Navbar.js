        ...
        <Container maxWidth="lg" >
            <Toolbar disableGutters >
                ...
                <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }} className={classes.linkBox}>
                    <Link to='/gowildwebsite' sx={{ my: 2, display: 'block' }} className={classes.linkItem} >
                        Home
                    </Link>
                ...
                <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                    ...
                    >
                        <MenuItem onClick={handleCloseNavMenu}>
                            <Link to='/gowildwebsite' sx={{ my: 2, color: 'white', display: 'block' }} className={classes.linkItemMobile}>Home </Link>
                        </MenuItem>
                        <MenuItem onClick={handleCloseNavMenu}>
